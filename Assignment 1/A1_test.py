...
start_tiles = [(21, 3), (3, 33), (4, 50), (2, 60), (4, 50), (17, 0), (53, 43), (30, 33), (47, 0),
               (30, 34), (61, 14), (30, 34), (1, 1), (13, 8), (63, 58), (51, 23), (40, 30),
               (15, 32), (20, 10), (0, 0)]
end_tiles = [(46, 3), (3, 55), (13, 58), (28, 2), (13, 59), (60, 50), (30, 43), (54, 33), (60, 45),
             (55, 39), (10, 44), (55, 40), (5, 5), (63, 8), (63, 0), (51, 45), (20, 30), (18, 18),
             (40, 10), (63, 63)]

# the solution grids
test_grid_solution = grid_solution.Grid(MAP_FILE)
test_grid_student = grid_student.Grid(MAP_FILE)
...
print(
    "\n------------------------------------------------------------------------------------------------------------------------------------------------")
print(
    "|                            |  Solution Generated Values                 |   Student "
    "Generated Values                 |   Student Correct    |")
print(
    "------------------------------------------------------------------------------------------------------------------------------------------------")
print(
    "| TEST |   START      END    |   CONN1  CONN2  CONN3  COST1  COST2  COST3 |   CONN1  CONN2  "
    "CONN3  COST1  COST2  COST3 |   SIZE1  SIZE2  SIZE3 |")
print(
    "------------------------------------------------------------------------------------------------------------------------------------------------")
for tile_index in range(len(start_tiles)):
    ...
    print("| %4d | (%3d,%3d) (%3d,%3d) | %7r%7r%7r%7d%7d%7d | %7r%7r%7r%7d%7d%7d | %7r%7r%7r |" % (
    tile_index + 1, start[0], start[1], end[0], end[1],
